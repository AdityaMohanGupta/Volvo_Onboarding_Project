...
var be = "employee-edit", xe = "employee-delete", Se = o`
  :host {
    --color-bg: #f5f5f5;
    --color-text: #1c1c1e;
...
`;
//#endregion
//#region src/components/employee-table/employee-table.template.ts
function Ee(e, t, n) {
	return R`
    <div class="row" role="row">
      <div class="cell" role="cell">${e.name}</div>
      <div class="cell" role="cell">${e.department}</div>
      <div class="cell" role="cell">${e.designation}</div>
      <div class="cell" role="cell">${e.email}</div>
...
function De(e) {
	let { employees: t, toast: n, onEdit: r, onDelete: i, onDismissToast: a } = e;
	return R`
    <div class="card">
      ${n ? R`
            <div class="toast" role="status">
              <span class="toast-icon">${Ce}</span>
              <span class="toast-message">${n}</span>
              <button class="toast-close" type="button" aria-label="Dismiss" @click=${a}>
                ${Z}
              </button>
            </div>
          ` : null}
      ...
      <div class="table-scroll">
        <div class="table" role="table" aria-label="Employee List">
          ...
          ${t.length === 0 ? R`<div class="row" role="row">
                <div class="cell empty" role="cell">No employees yet</div>
              </div>` : t.map((e) => Ee(e, r, i))}
        </div>
      </div>
    </div>
  `;
...
//#endregion
//#region src/components/employee-table/employee-table.ts
var $ = class extends Y {
	constructor(...e) {
		super(...e), this.employees = [], this.toast = null, this.toastTimeoutId = null;
	}
	disconnectedCallback() {
	...
	handleEdit(e) {
		this.dispatchEvent(new CustomEvent(be, {
			detail: e,
			bubbles: !0,
			composed: !0
		}));
	...
	handleDelete(e) {
		this.showToast("Employee deleted successfully!"), this.dispatchEvent(new CustomEvent(xe, {
			detail: e,
			bubbles: !0,
			composed: !0
		}));
...
Q([X({ attribute: !1 })], $.prototype, "employees", void 0), Q([ye()], $.prototype, "toast", void 0), $ = Q([ge("employee-table")], $);
//#endregion
export { $ as EmployeeTable };
